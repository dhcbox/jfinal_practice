...
public class BlogController extends Controller {
	 ...
	 */
	public void delete() {
		boolean result = enhance(BlogService.class).deleteBlogById(getParaToInt());
		if (!result) {
	...
	public void save() {
		String result = enhance(BlogService.class).saveBlog(getModel(Blog.class));
	...
	public void update() {
		boolean result = enhance(BlogService.class).updateBlog(getModel(Blog.class));
		if (!result) {
